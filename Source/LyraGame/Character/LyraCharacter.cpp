	...
	: Super(ObjectInitializer.SetDefaultSubobjectClass<ULyraCharacterMovementComponent>(ACharacter::CharacterMovementComponentName))
{
	...
	LyraMoveComp->MaxAcceleration = 5000.0f;
	...
	LyraMoveComp->MaxCustomMovementSpeed=1000.0f;
	LyraMoveComp->MaxWalkSpeed=700.0f;
...
void ALyraCharacter::ToggleCrouch()
{
	...
	else if (LyraMoveComp->IsMovingOnGround()&&LyraMoveComp->CanStartSlide())//do they meet the requirements for sliding?
	{
		LyraMoveComp->BeginSlide();
	}
